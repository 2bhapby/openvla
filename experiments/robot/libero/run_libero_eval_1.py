...
def eval_libero(cfg: GenerateConfig) -> None:
    ...
    # eval_libero.py, local_log_filepath 바로 아래
    run_dir = os.path.join(cfg.local_log_dir, run_id)
    ...
    for task_id in tqdm.tqdm(range(num_tasks_in_suite)):
        ...
        for episode_idx in tqdm.tqdm(range(cfg.num_trials_per_task)):
            # if episode_idx > 0:
            #     continue  # Skip all but the first episode for this task
            ...
            while t < max_steps + cfg.num_steps_wait:
                try:
                    ...
                    print(f"Episode {task_episodes+1} step {t}:")
